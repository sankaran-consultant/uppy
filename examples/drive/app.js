...
module.exports = function (props) {
  ...
  return _ = document.createElement('tr'), _.onclick = props.handleClick, _.ondblclick = props.handleDoubleClick, _.setAttribute('class', '' + String(classes) + ''), _appendChild(_, ['\n      ', Column({
    getItemIcon: props.getItemIcon,
    value: props.title
  }), '\n    ']), _;
};
...
},{"../../../../src/core/Core.js":15,"../../../../src/plugins/GoogleDrive":29,"../env":35}],35:[function(require,module,exports){
'use strict';
